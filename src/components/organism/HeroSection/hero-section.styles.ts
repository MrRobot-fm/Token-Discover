export const styles = {
  main: "flex max-w-[144rem] justify-between gap-[4rem] py-[2.5rem] md:flex-col md:items-start lg:flex-row lg:items-center lg:pb-[8rem] xl:py-[5rem] 2xl:py-[15rem] relative overflow-hidden",
