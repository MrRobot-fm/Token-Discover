...
export type GetNftsByContractSearchParams = {
  chain: string;
  contract_address: string;
  cursor?: string;
  limit?: number;
...
export type UseGetNftsByContractApiParams = {
  chain: string;
...
export type GetNftByContractResponseModel = {
  next: string | null;
...
export type GetInfiniteNftByContractResponseModel = {
  pageParams: string[];
  pages: GetNftByContractResponseModel[];
};
